<?php
    ...
    require_once("../models/Log_Bitacora.php");
    $log_bitacora = new Log_Bitacora();
    ...
    switch ($_GET["opcion"]){
        ...
        case "InsertLog_Bitacora":
            $datos = $log_bitacora -> insert_log_bitacora($body["ID_LOG"], $body["FECHA"], $body["ACCION"], $body["FORMULARIO"], $body["USUARIO"]);
